...
export function JournalShell({ children, contentWidth = 'wide' }: JournalShellProps) {
  ...
  return (
    <div className="min-h-screen bg-[#080808] text-white">
      <div className="pointer-events-none fixed inset-0 bg-[radial-gradient(circle_at_top_right,rgba(240,168,85,0.12),transparent_28%),radial-gradient(circle_at_bottom_left,rgba(200,130,58,0.10),transparent_24%),linear-gradient(180deg,rgba(255,255,255,0.01),transparent_34%)]" />
      <div className={`relative mx-auto ${widthClass} px-4 py-5 sm:px-6 sm:py-6 lg:px-8 xl:px-10 xl:py-8 2xl:px-12`}>
        <div className="grid min-w-0 gap-5 xl:grid-cols-[300px_minmax(0,1fr)] xl:gap-7 2xl:grid-cols-[320px_minmax(0,1fr)] 2xl:gap-8">
