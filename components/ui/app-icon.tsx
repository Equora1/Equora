...
export function AppIcon({ name, className, ...props }: { name: AppIconName } & SVGProps<SVGSVGElement>) {
  ...
  if (name === 'sync') {
    return (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" className={resolvedClassName} {...props}>
        <path d="M7 7h8.5a3.5 3.5 0 0 1 3.5 3.5V12" strokeLinecap="round" />
        <path d="M17 5l2 2-2 2" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M17 17H8.5A3.5 3.5 0 0 1 5 13.5V12" strokeLinecap="round" />
        <path d="M7 19l-2-2 2-2" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    )
  }
