      ...
      <div className="grid gap-4 xl:grid-cols-[1.05fr_0.95fr]">
        <div className="rounded-3xl border border-emerald-400/15 bg-emerald-400/6 p-5">
          ...
          <div className="mt-5 flex flex-wrap gap-2">
            ...
            <Link href={`/trades?reviewFocus=${encodeURIComponent(plan.dailyFocusSuggestion)}`} className="rounded-full border border-white/10 bg-black/25 px-3 py-1.5 text-xs text-white/72 transition hover:border-white/20 hover:text-white">
              In Trades öffnen
            </Link>
          </div>
        </div>
        ...
        <div className="rounded-3xl border border-white/10 bg-black/25 p-5">
          <p className="text-[10px] uppercase tracking-[0.22em] text-white/35">Schritt</p>
