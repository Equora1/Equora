...
export function getFirstUserOnboarding({
  ...
  const steps: FirstUserStep[] = [
    ...
    },
    {
      ...
      detail: hasReviewSeed
        ? 'Es gibt genug Stoff für Review und erste Muster.'
        : 'Drei Trades oder eine Review-Notiz reichen bereits, damit Review nicht im Leerlauf läuft.',
  ...
  switch (stage) {
    ...
    case 'review':
      ...
      copy = 'Noch ein paar Trades oder eine Review-Notiz, dann kann Equora bereits echte Muster und Warnsignale zeigen.'
      nextActionLabel = 'Noch 1-2 Trades oder eine Review-Notiz ergänzen'
