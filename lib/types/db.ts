...
export type TradeImportBatchRow = {
  id: string
  user_id?: string | null
  created_at: string
  ...
  status: 'active' | 'reverted' | string | null
...
export type SetupSuggestionRow = {
  id: string
  user_id?: string | null
  created_at?: string | null
  updated_at?: string | null
  status: 'pending' | 'accepted' | 'rejected' | 'archived' | null
  title: string
  category: string | null
  description: string | null
  entry: string | null
...
export type BrokerConnectionStatus = 'draft' | 'ready' | 'paused' | 'error' | 'revoked'
export type BrokerEnvironment = 'live' | 'demo'
export type BrokerSyncMode = 'manual' | 'scheduled'
...
export type BrokerConnectionRow = {
  ...
  status: BrokerConnectionStatus | string
  permissions: string[] | null
  sync_mode: BrokerSyncMode | string
...
export type BrokerRawEventRow = {
  ...
  import_status: 'pending' | 'imported' | 'skipped' | 'error' | string
