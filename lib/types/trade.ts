...
export type TradeCalculationSource = 'manual' | 'realized' | 'realized_partial' | 'planned' | 'missing'
...
export type Trade = {
  ...
  importTrustScore?: number | null
  importTrustLabel?: string | null
...
export type TradeDetail = {
  ...
  importPresetLabel?: string
  importFieldSourceFacts?: Array<{ label: string; value: string }>
}
